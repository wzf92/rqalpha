...
from rqalpha.apis.api_abstract import order, order_to, buy_open, buy_close, sell_open, sell_close, order_target_percent
...
from rqalpha.const import DEFAULT_ACCOUNT_TYPE, SIDE, POSITION_EFFECT, ORDER_TYPE, RUN_TYPE, INSTRUMENT_TYPE, POSITION_DIRECTION
...
# def _get_account_position_ins(id_or_ins, direction):
#     ins = assure_instrument(id_or_ins)
#     account = Environment.get_instance().portfolio.accounts[DEFAULT_ACCOUNT_TYPE.FUTURE]
#     position = account.get_position(ins.order_book_id, direction)
#     return account, position, ins


# @order_target_percent.register(INSTRUMENT_TYPE.FUTURE)
